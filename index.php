...
<body>
        <div class="main">
            <form action="insert.php" method="post" enctype="multipart/form-data">
                ...
                <input type="text " requierd placeholder="Product Name" name='name'>
                <br>
                <input type="text" name='price' requierd placeholder="Price">
                <br>
                <input  type="file" id="file" name='image' style='display:none;'>
                <label required for="file">Choose Image For Product</label>
